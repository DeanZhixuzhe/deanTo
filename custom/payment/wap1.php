...
<body>
    <div id="main">
        <form action="alipay_wap/alipayapi.php" method=post target="_blank" name="payment" id="payment">
            <div id="body">
                <div class="miaoshu">
                    <img src="images/miaoshu_m.png">
                </div>
                <div class="jine">
                    待付金额：￥<input id="WIDtotal_fee" name="WIDtotal_fee" value="<?php $trueprice = $_POST['trueprice']; echo $trueprice; ?>" readonly="ture"/>
                </div>
                <div class="ddid">
                    订单编号：<input id="WIDout_trade_no" name="WIDout_trade_no" readonly="ture" />
                </div>
                <div class="spname">
                    <input id="WIDsubject" name="WIDsubject" value="<?php $title = $_POST['title']; echo iconv('GBK','UTF-8',$title); ?>" readonly="ture"/>
                </div>
                <dl class="content">
            ...
            <div class="paymode">
                <h2>选择支付方式</h2>
				<label><img src="images/alipay_m.png"><input type="radio" name="pingtai" value="alipay_pc/alipayapi.php" checked="checked" onclick="getValue()"></label>
			</div>
            <div class="paymode">
                <h4>更多支付方式</h4>
                <div class="hide">
                    <label><img src="images/wechat_m.png"><input type="radio" name="pingtai" value="wechat/example/jsapi.php" onclick="getValue()"></label>
                </div>
            </div>
            <div id="btn-dd">
