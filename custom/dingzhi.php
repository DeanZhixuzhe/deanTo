...
if ($action == 'post')
{
    ...
    {
        if ($t == 0) {
            include DEDEROOT."/templets/plus/dingzhi.htm";
            exit();
        }elseif ($t == 1) {
            include DEDEROOT."/templets/plus/dingzhi_m.htm";
            exit();
        }else{
            echo "<script type='text/javascript'>window.location.href='/romantic/dingzhi.php?action=post&t=1'</script>";
            exit();
        }
    }
    elseif($do == 2)
