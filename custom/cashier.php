...
<style>
	...
	*{margin: 0;}
	...
	.info{background: url(payment/images/bj.png) no-repeat; width: 820px; height: 285px; margin: auto; clear: both;}
...
<body>
	<div class="header">
		<img src="payment/images/logo.png" class="logo">
	</div>
	<div class="content">
	<form action="alipay_pc/alipayapi.php" class="alipayform" method="post" target="_blank" name="payment" id="payment">
		<div class="miaoshu">
			...
			<div class="m2"><p>由于预定客户较多，为了避免档期和人员安排冲突，请您在15分钟内完成支付！<em><img src="payment/images/bao.png">在线支付保障</em>请您放心购买。</p><span></span></div>
		...
		<div class="info">
			<div class="ipt">
				...
				<div class="paymode">
					<label><input type="radio" name="pingtai" value="alipay_pc/alipayapi.php" checked="checked" onclick="getValue()"><img src="payment/images/alipay.png"></label>
				</div>
				<div class="isubmit">
		...
		<div class="paymode_more">
			<h4>更多支付方式</h4>
			<div class="hide">
			<label><input type="radio" name="pingtai" value="wechat/example/native.php" onclick="getValue()"><img src="payment/images/wechat.png"></label>
			<label class="hide"><input type="radio" name="pingtai" value="tenpay" onclick="getValue()"><img src="payment/images/tenpay.png"></label>
			</div>
		</div>
