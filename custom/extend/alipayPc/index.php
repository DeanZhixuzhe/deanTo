...
function browserRedirect() {
        ...
        {                      
            window.location.href='../alipay_wap/';
        }             
}             
browserRedirect();
</script>
	...
	<div class="content">
		<form action="alipayapi.php" class="alipayform" method="post" target="_blank">
			...
			<div class="element">
				...
				<div class="einput"><input type="text" name="WIDout_trade_no" id="out_trade_no" readonly="ture"></div>
				<br>
			...
			<div class="element">
				...
				<div class="einput"><input type="text" name="WIDsubject" value="test商品123" readonly="ture"></div>
				<br>
				<div class="mark">注意：产品名称(subject)，必填(建议中文，英文，数字，不能含有特殊字符)</div>
			</div>
			<div class="element">
				<div class="etitle">付款金额:</div>
				<div class="einput"><input type="text" name="WIDtotal_fee" value="0.01" readonly="ture"></div>
				<br>
