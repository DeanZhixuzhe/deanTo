...
class WxPayDataBase
{
	...
	* @param string $value 
	**/
	public function SetSandbox_signkey($value)
	{
		$this->values['sandbox_signkey'] = $value;
...
{	
	...
	**/
	...
	/**
	* 设置订单代金券金额，只能为整数，详见支付金额
	* @param string $value 
	**/
	public function SetCoupon_fee($value)
	{
		$this->values['coupon_fee'] = $value;
	}
	/**
	* 获取订单代金券金额，只能为整数，详见支付金额的值
	* @return 值
	**/
	public function GetCoupon_fee()
	{
		return $this->values['coupon_fee'];
	}
